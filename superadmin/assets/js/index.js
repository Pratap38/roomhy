lucide.createIcons();
        ...
        async function loginSuperAdmin(email, password, errorMsg) {
            ...
            if (!db && email === 'roomhyadmin@gmail.com' && password === 'admin@123') {
                ...
                window.location.href = resolvePanelPath('superadmin', 'superadmin.html');
                return;
            }
        ...
        function loginOwner(ownerId, password, errorMsg) {
            ...
            if (storedPass === password) {
                ...
                window.location.href = resolvePanelPath('propertyowner', 'admin.html');
            } else {
        ...
        function loginAreaManager(loginId, password, errorMsg) {
            ...
            if (mgr) {
                ...
                sessionStorage.removeItem('owner_session');
                localStorage.removeItem('owner_user');
                window.location.href = resolvePanelPath('superadmin', 'areaadmin.html');
            } else {
        ...
        function createTenantSessionAndRedirect(tenant) {
            ...
            window.location.href = resolvePanelPath('tenant', 'tenantdashboard.html');
        }
        ...
        async function sendOTP() {
            ...
            // Step 1: Check local databases first (manager.html, employees, etc.)
            ...
            // Check Area Managers (from manager.html)
            if (!staffFound) {
                try {
