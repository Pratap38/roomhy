...
class SuperAdminNotificationManager {
    ...
    updateSidebarBadges() {
        ...
        this.upsertSidebarBadge('booking.html', counts.new_booking);
        this.upsertSidebarBadge('enquiry.html', counts.new_enquiry);
        this.upsertSidebarBadge('new_signups.html', counts.new_signup);
    }
