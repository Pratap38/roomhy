...
router.post('/owner/forgot-password/request-otp', otpLimiter, captchaProtection({ required: true }), authController.ownerForgotPasswordRequestOTP);
...
router.post('/tenant/forgot-password/request-otp', otpLimiter, captchaProtection({ required: true }), authController.tenantForgotPasswordRequestOTP);
...
router.post('/forgot-password/request-otp', otpLimiter, captchaProtection({ required: true }), authController.forgotPasswordRequestOTP);
