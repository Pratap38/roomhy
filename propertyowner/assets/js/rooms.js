window.addEventListener('load', () => { if(typeof lucide!=='undefined') lucide.createIcons(); });
        ...
        async function ensureCorrectPropertyId() {
            ...
            try {
                ...
                // PRIORITY 2: Superadmin property source (/api/properties) used by superadmin/properties.html.
                if (backendBase) {
                ...
                // PRIORITY 3: Cached property data populated by superadmin/properties.html.
                try {
        ...
        function showCredentialsModal(name, id, pass, email, assignmentDetails = {}) {
            ...
            if (email) {
                try {
                    ...
                    const checkinLink = `${checkinBase}/digital-checkin/tenantprofile.html?loginId=${encodeURIComponent(id)}`;
