          ...
          <div className="flex h-screen overflow-hidden">
              ...
              <aside className="sidebar w-72 flex-shrink-0 hidden md:flex flex-col z-20 overflow-y-auto custom-scrollbar">
                  ...
                  <nav className="flex-1 py-6 space-y-1">
                      ...
                      <a href="/superadmin/tenant" className="sidebar-link"><i data-lucide="folder-open" className="w-5 h-5 mr-3"></i> Tenant Records</a>
                      ...
                      <a href="/superadmin/complaint-history" className="sidebar-link"><i data-lucide="alert-circle" className="w-5 h-5 mr-3"></i> Complaint History</a>
                      ...
                      <div className="group">
                          <div className="sidebar-link justify-between" onClick={function(event) { try { return Function('event', "toggleSubmenu('finance-submenu', this)").call(event.currentTarget, event); } catch (err) { console.error(err); } }}>
                      ...
                      <div className="mt-6 px-6 pb-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">System</div>
                       <a href="/superadmin/superchat" className="sidebar-link"><i data-lucide="message-square" className="w-5 h-5 mr-3"></i> Chats</a>
              ...
              <aside id="mobile-sidebar" className="fixed inset-y-0 left-0 w-72 bg-[#111827] z-40 transform -translate-x-full transition-transform duration-300 md:hidden flex flex-col overflow-y-auto">
                  ...
                  <nav className="flex-1 py-4 space-y-1 px-2">
                       ...
                       <a href="#" className="flex items-center px-4 py-3 text-sm font-medium rounded-md bg-gray-800 text-white border-l-4 border-purple-500">Settings</a>
                  </nav>
              </aside>
          </div>
