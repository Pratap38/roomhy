      ...
      <div className="flex h-screen overflow-hidden">
        <aside className="sidebar bg-[#111827] w-72 flex-shrink-0 hidden md:flex flex-col">
          ...
          <nav className="flex-1 py-6">
            <a href="/superadmin/enquiry" className="flex items-center px-6 py-3 text-gray-400 hover:text-white transition-all">
              <i data-lucide="help-circle" className="w-5 h-5 mr-3"></i> Enquiries
            </a>
            <a href="/superadmin/website" className="flex items-center px-6 py-3 text-gray-400 hover:text-white transition-all">
        ...
        <div className="flex-1 flex flex-col">
          <header className="bg-white h-16 shadow-sm flex items-center px-8 border-b border-gray-200">
            <a href="/superadmin/enquiry" className="mr-4 text-gray-400 hover:text-purple-600 transition-colors">
