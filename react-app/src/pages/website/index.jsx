                          ...
                          <div className="p-8 md:p-16 bg-white contact-content rounded-r-3xl">
                              <form className="space-y-6">
                                  ...
                                  <div>
                                      ...
                                      <input type="text" id="contact-name" name="contactName" className="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-purple-500 focus:border-purple-500" placeholder="Name" />
                                  </div>
